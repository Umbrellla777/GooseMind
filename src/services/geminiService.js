    ...
    async analyzeMessage(text) {
        try {
            const prompt = `Проанализируй текст и определи:
                          ...
                          4. 2-3 ключевых слова для ответа в том же стиле
                          5. Если есть маты - включи их в ключевые слова
                          6. Подходящие эмодзи (если уместно)
    ...
    async improveText(text) {
        try {
            const prompt = `Напиши одно предложение, используя ВСЕ эти слова: ${text}
                           ...
                           - Если в словах есть вопросительные слова (кто, что, где, когда) - сделай вопрос
                           - Если есть эмоциональные слова - добавь соответствующие знаки (!!)
                           - Сохраняй стиль и тон исходных слов
