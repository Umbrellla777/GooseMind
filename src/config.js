    ...
    CHARACTER_SETTINGS: {
        divine: {
            ...
            traits: [
                ...
                'Используешь только самые добрые слова',
                'Видишь во всем божественный замысел'
            ]
        },
        angelic: {
            name: 'Ангельский (800 до 900)',
            swearProbability: 0,
            traits: [
